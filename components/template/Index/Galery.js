    ...
    <>
      <div class="gallery">
        <figure class="gallery__box gallery__box-1">
          <img src="img/gal-1.jpeg" alt="Galley house-1" class="gallery__img" />
        </figure>
        <figure class="gallery__box gallery__box-2">
          <img src="img/gal-2.jpeg" alt="Galley house-2" class="gallery__img" />
        </figure>
        <figure class="gallery__box gallery__box-3">
          <img src="img/gal-3.jpeg" alt="Galley house-3" class="gallery__img" />
        </figure>
        <figure class="gallery__box gallery__box-4">
          <img src="img/gal-4.jpeg" alt="Galley house-4" class="gallery__img" />
        </figure>
        <figure class="gallery__box gallery__box-5">
          <img src="img/gal-5.jpeg" alt="Galley house-5" class="gallery__img" />
        </figure>
        <figure class="gallery__box gallery__box-6">
          <img src="img/gal-6.jpeg" alt="Galley house-6" class="gallery__img" />
        </figure>
        <figure class="gallery__box gallery__box-7">
          <img src="img/gal-7.jpeg" alt="Galley house-7" class="gallery__img" />
        </figure>
        <figure class="gallery__box gallery__box-8">
          <img src="img/gal-8.jpeg" alt="Galley house-8" class="gallery__img" />
        </figure>
        <figure class="gallery__box gallery__box-9">
          <img src="img/gal-9.jpeg" alt="Galley house-9" class="gallery__img" />
        </figure>
